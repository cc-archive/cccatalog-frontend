...
export const FETCH_IMAGE_SOURCES_END = 'FETCH_IMAGE_SOURCES_END';
export const SET_FETCH_IMAGES_ERROR = 'SET_FETCH_IMAGES_ERROR';
export const FETCH_IMAGE_SOURCES_START = 'FETCH_IMAGE_SOURCES_STAR';
...
export const SET_IMAGE_SOURCES = 'SET_IMAGE_SOURCES';
