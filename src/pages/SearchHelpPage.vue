  ...
  <div class="guide page">
    ...
    <div class="content">
      <Container>
        ...
        <h2>
          <i18n path="categories.searchby" tag="span">
            {{ $t('categories.exactness') }}
          </i18n>
        </h2>
        <p>
          ...
          <Table color="blue"
            ...
            <template #head>
              <tr>
                ...
                <TableCell is-heading>{{ $t('code') }}</TableCell>
              </tr>
            </template>
            <template #default>
              <tr v-for="(provider, index) in imageProviders"
                ...
                <TableCell is-actionable
                           @click.native="goToProvider(providerSearchLink(provider.provider_name))">
        ...
        <p>
          ...
          <br/>
          If you want to combine tags, you can use the AND operator, or the OR
          operator, depending on your search preference.
        ...
        <ul>
          <li>
            <a
              href='https://ccsearch.creativecommons.org/search?q=license%3A"by"%20AND%20%28NOT%20provider%3A"flickr"%29'>
          ...
          <li>
            <a
              href='https://ccsearch.creativecommons.org/search?q=tags.name%3A"bird"%20AND%20%28NOT%20tags.name%3A"flamingo"%29'>
...
<i18n src="../locales/pages/SearchHelpPage.json">
</i18n>
